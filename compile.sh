...
$CC $CFLAGS -c -o vtuner-utils.$ARCH.o vtuner-utils.c
$CC $CFLAGS $LDFLAGS -o vtunerd.$ARCH vtuner-network.$ARCH.o vtunerd-service.$ARCH.o vtuner-dvb-3.$ARCH.o vtuner-utils.$ARCH.o vtunerd.c
...
$CC $CFLAGS -c -o vtuner-network.$ARCH.o vtuner-network.c
$CC $CFLAGS -c -o vtuner-utils.$ARCH.o vtuner-utils.c
$CC $CFLAGS $LDFLAGS -o vtunerc.$ARCH vtuner-network.$ARCH.o vtuner-utils.$ARCH.o vtunerc.c
...
$CC $CFLAGS -c -o vtunerd-service.$ARCH.o vtunerd-service.c
$CC -shared -Wl,-soname,libvtuner-$ARCH.so -o libvtuner-$ARCH.so vtuner-network.$ARCH.o vtunerd-service.$ARCH.o vtuner-dmm-3.$ARCH.o vtuner-utils.$ARCH.o -lc
...
$CC $CFLAGS -c -o vtuner-utils.$ARCH.o vtuner-utils.c
$CC $CFLAGS $LDFLAGS -o vtunerd.$ARCH vtuner-network.$ARCH.o vtunerd-service.$ARCH.o vtuner-dmm-2.$ARCH.o vtuner-utils.$ARCH.o vtunerd.c
